...
class RealNVP(nn.Module):
    def __init__(self, nets, nett, mask, d, lmbda0=None, k0=None):
        ...
        if lmbda0 is not None and k0 is not None:
            ...
            self.lmbdas = torch.nn.Parameter(torch.cat((torch.ones(1, 1), torch.rand(d-1, 1)+lmbda0)), requires_grad=True)
