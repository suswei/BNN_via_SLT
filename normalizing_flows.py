...
class RealNVP(nn.Module):
    def __init__(self, nets, nett, mask, d):
        ...
        self.lmbdas = torch.nn.Parameter(torch.cat((torch.rand(1, 1)+40, torch.rand(d-1, 1)+40)), requires_grad=True)
        self.ks = torch.nn.Parameter(torch.cat((torch.rand(1, 1), torch.rand(d-1, 1))), requires_grad=True)
